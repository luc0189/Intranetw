<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/Main.Master" AutoEventWireup="true" CodeBehind="VentasXhora.aspx.cs" Inherits="Intranet.Vista.Documentos.VentasXhora" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
      <head>
        <title>LCSystem 3 | Ventas por Hora</title>
    </head>
</asp:Content>
                           ...
                           <div class="col-md-3">
                            ...
                            <div class="box box-danger">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="GridViewCiuaudadela" runat="server" GridLines="None"
                                        CssClass="gvuser4 table table-striped table-bordered text-sm"
                                        CellSpacing="0" EmptyDataText="No se encontraron Registros con los parametros indicados.">
                                    </asp:GridView>
                                   ...
                                   <div class="table-responsive">
                                                <asp:GridView ID="GridView2ciudaela" runat="server" GridLines="None"
                                                    CssClass="gvuser1 table table-striped table-bordered text-sm"
                                                    CellSpacing="0" EmptyDataText="No se encontraron Registros con los parametros indicados.">
                                                </asp:GridView>
                                            </div>
