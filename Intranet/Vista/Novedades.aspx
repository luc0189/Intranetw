<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/Main.Master" AutoEventWireup="true" CodeBehind="Novedades.aspx.cs" Inherits="Intranet.Vista.Novedades" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
      <head>
        <title>LCSystem 3 | Novedades</title>
    </head>
</asp:Content>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <input type="number" runat="server" id="hours" name="Horas" value="1" class="form-control" min="1" max="2" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" runat="server" id="id39" name="radio1" data-has-listeners="true" wfd-id="id39">
                                            <label class="form-check-label">Diurno</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="radio1" runat="server" id="id40" checked="" data-has-listeners="true" wfd-id="id40">
