...
{
    public partial class Rotacionsalas : System.Web.UI.Page
    {
        ...
        protected void Consultar_Click(object sender, EventArgs e)
        {
            ...
            var numeronit= nit.Value.ToString();
            Ejecuta(ccosto,numeronit);
        }
        ...
        public void Ejecuta(string sala,string numnit)
        {
            try
            {
              
                var registros = Controlador.Controlasql.CRotacionsalasventas(date1.Value, numnit, sala);
                if (registros.Tables[0].Rows.Count > 0)
                {
        ...
        protected void Consultaadmon_Click(object sender, EventArgs e)
        {
            ...
            string nombresala = palabras[1];
            var numeronit = nit.Value.ToString();
            Ejecuta(nombresala, numeronit);
        }
    }
}