...
namespace Intranet.Vista
{
    ...
    public partial class Acta_entrega : System.Web.UI.Page
    {
        ...
        public void Button3_Click(object sender, EventArgs e)//Guardar
        {
                ...
                foreach (GridViewRow row in GridViewdetalle.Rows)
                    ...
                    string detalleobserva = Page.Server.HtmlDecode(row.Cells[2].Text);
                    string dat = ahora;
                      string test = serialtemp;
                        string[] palabras = test.Split('/');
                         string serial = Page.Server.HtmlDecode(palabras[0]);
