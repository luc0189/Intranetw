<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/Main.Master" AutoEventWireup="true" CodeBehind="VentasGla14.aspx.cs" Inherits="Intranet.Vista.VentasGla14" %>
                              ...
                              <div class="shadow p-3 mb-2 bg-body rounded">
                                <div class="row align-items-start">
                                    ...
                                    <div class="col-md-4" id="boton">
                                        ...
                                        <asp:LinkButton ID="activos" runat="server" Text="Listar Activos" CssClass="btn btn-default"
                        OnClick="Listarventasla14">
