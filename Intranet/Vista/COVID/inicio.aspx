<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="inicio.aspx.cs" Inherits="Intranet.Vista.COVID.inicio" %>
...
<body class="hold-transition login-page" style="height:100%;  width:100%; background-repeat: no-repeat;background-size:100%;">

        <div class="box box-info box-solid notifica " id="notificacion" runat="server" style="display: none;">
        ...
        <div class="login-box cajalogin" style="">
            ...
            <div class="login-box-body">
                ...
                <h1 class="login-logo">
                    <b>Seleccione el area</b> </h1>
                <form runat="server" method="post">
            
                    <div class="form-group has-feedback">
                        <select runat="server" id="selectAREA" class="form-control">
