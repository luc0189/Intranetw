<%@ Page Title="Dias Sin Rotacion" Language="C#" MasterPageFile="~/Vista/Main.Master" AutoEventWireup="true" CodeBehind="Rotacionsalas.aspx.cs" Inherits="Intranet.Vista.Rotacionsalas" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <head>
        <title>LCSystem 3 | Rotacion Inventario</title>
    </head>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Reporte Rotacion de Inventario</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-dark">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label  runat="server" class="col-sm-3 col-form-label">Nit:</label>
                                    <input type="text" name="name" class="col-sm-9 form-control" value="" runat="server" id="nit" />
                                </div>
